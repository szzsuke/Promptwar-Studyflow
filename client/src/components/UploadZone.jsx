  ...
  return (
    <div className="upload-container">
      ...
      <div
        ...
        tabIndex={0}
        role="region"
        aria-label="Document upload drop zone. Drag and drop file or press enter to browse files."
      ...
      {validationError && (
        <div id="validation-error-alert" className="validation-error" role="alert" aria-live="polite">
